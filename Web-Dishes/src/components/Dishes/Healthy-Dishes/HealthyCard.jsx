...
function HealthyCard({
  ...
  return (
    <div className="relative flex flex-col justify-between bg-[#00544f] flex-shrink text-white mt-20 shadow-md rounded-lg p-4 border border-gray-200 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg md:hover:shadow-2xl hover:border-gray-300 hover:scale-105">
...
<div className={`${dishType === 'Non-Veg' ? 'bg-[#f01010]' : 'bg-[#16b426]'} border-2 border-black rounded-full h-4 w-4`} />
      ...
      <div className="flex items-center justify-center -mt-16">
        <div className="relative">
          ...
          <div className="absolute bottom-0 right-0 bg-black bg-opacity-70 text-white px-2 py-1 rounded-lg">
            <CiStar className="inline-block text-yellow-500 mr-1" />
            <span>{rating}K</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center">
        <h2 className="text-lg text-white text-center font-bold mb-2  max-w-[15rem]">{title}</h2>
      ...
      <div className="bg-white text-black w-full p-4 rounded-b-lg">
        ...
        <hr className="w-full border-1 border-gray-600 mb-2" />
          <ul className="flex items-center justify-around gap-5 text-sm">
            ...
            <div className="flex flex-col items-center">
              <li className="font-bold">{nutritionalValues.protein} </li>
              <li>Protein</li>
            </div>
            <div className="flex flex-col items-center">
              <li className="font-bold">{nutritionalValues.carbs} </li>
              <li>Carbs</li>
            </div>
            <div className="flex flex-col items-center">
              <li className="font-bold">{nutritionalValues.fats} </li>
              <li>Fats</li>
            </div>
            <div className="flex flex-col items-center">
              <li className="font-bold">{nutritionalValues.fiber} </li>
              <li>Fiber</li>
            </div>
         </ul>
      </div>
