...
<div className="flex flex-wrap justify-evenly gap-3 mb-8">
  ...
  <div className='relative w-full md:w-1/2  '>
    ...
    <input
      ...
      type='search' onChange={handleSearchChange} placeholder='Search Dish' className='shadow-lg text-sm font-medium py-2 sm:py-3 px-6 sm:px-10 text-start text-black w-full' />
  ...
  <div className="w-full md:w-36 ">
    <Dropdown
      style={{boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)', // Manually adding shadow-lg style
